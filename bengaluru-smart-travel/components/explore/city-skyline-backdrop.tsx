    ...
    <svg viewBox="0 0 1400 700" preserveAspectRatio="xMidYMid slice" className="absolute inset-0 -z-10 h-full w-full">
      <defs>
        <linearGradient id="heroSky" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="55%" stopColor="#120B22" />
      ...
      <ellipse cx="700" cy="120" rx="500" ry="200" fill="url(#heroGlow)" />
      {[...Array(60)].map((_, i) => (
        <circle
          key={i}
          cx={((i * 61 + 20) % 1380) + 10}
      ...
      <rect x="0" y="630" width="1400" height="70" fill="#050308" />
    </svg>
  );
}
