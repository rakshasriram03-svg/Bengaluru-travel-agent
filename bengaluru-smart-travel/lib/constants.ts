  ...
  days: [
    {
      ...
      items: [
        { time: "09:00", text: "Breakfast at **Hole in the Wall**, Koramangala." },
        { time: "11:30", text: "Tour of **Microsoft Research Lab**." },
      ],
    },
    {
      label: "Day 2",
      ...
      items: [
        { time: "10:00", text: "Visit **Industrial & Tech Museum**." },
        { time: "14:00", text: "Lunch at a **Robotic Cafe** in Indiranagar." },
      ],
    },
  ],
  followUp:
